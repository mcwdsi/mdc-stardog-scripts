...
/opt/stardog/stardog-5.2.2/bin/stardog data add -u $1 --named-graph http://www.pitt.edu/obc/ide/apollo-sv MDC ~/owl-files/merged-apollo-sv-2018-04-12.owl
/opt/stardog/stardog-5.2.2/bin/stardog data add -u $1 --named-graph http://www.pitt.edu/obc/ide/classes-and-indexing-instances MDC ~/owl-files/all-indexing-instances-and-classes-2018-04-12.owl
...
/opt/stardog/stardog-5.2.2/bin/stardog data add -u $1 --named-graph http://www.pitt.edu/obc/mdc/content MDC ~/owl-files/license-ontology-2018-04-13.owl
/opt/stardog/stardog-5.2.2/bin/stardog data add -u $1 --named-graph http://www.pitt.edu/obc/mdc/content MDC ~/owl-files/data-format-ontology-2018-04-13.owl
/opt/stardog/stardog-5.2.2/bin/stardog data add -u $1 --named-graph http://www.pitt.edu/obc/mdc/content MDC ~/owl-files/software-ontology-2018-04-13.owl
/opt/stardog/stardog-5.2.2/bin/stardog data add -u $1 --named-graph http://www.pitt.edu/obc/mdc/content MDC ~/owl-files/dataset-ontology-2018-04-13.owl
